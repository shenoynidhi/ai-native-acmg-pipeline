...
# Check if HPO NLP should use MedGemma (selective routing)
USE_MEDGEMMA = os.getenv("HPO_USE_MEDGEMMA", "false").lower() == "true"
if USE_MEDGEMMA:
    from src.utils.medgemma_client import call_medgemma_json
    logger.info("HPO NLP will use MedGemma")
