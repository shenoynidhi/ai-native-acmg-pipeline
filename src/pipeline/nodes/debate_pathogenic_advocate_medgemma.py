...
if USE_MEDGEMMA:
    ...
    logger.info("Pathogenic advocate will use MedGemma for debate")
...
def debate_pathogenic_advocate_node(state: VariantState) -> dict:
    ...
    # Use MedGemma if flag is set, otherwise use default (Gemma 12B or Bedrock gpt-oss)
    if USE_MEDGEMMA:
        ...
        # Use Bedrock gpt-oss-20b with medium reasoning
