...
def _normalise_citations(citations_str: str) -> list:
    """
    Takes the raw semicolon-joined citations string and returns a
    cleaned, deduplicated list with consistent formatting.
    PMIDs are converted to a standard format.
