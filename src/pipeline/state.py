...
class VariantState(TypedDict):
    ...
    cleaned_vcf:       Optional[str]   # Path to VCF with alternate contigs removed (set by strip_alternate_contigs_node)
    filtered_vcf:      Optional[str]   # Path to filtered VCF (set by prefilter_node)
...
def build_initial_state(
    ...
    return VariantState(
        ...
        phase_partner    = None,
        zygosity         = None,  # het/hom/hemi from VCF GT field
