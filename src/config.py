...
class PipelineConfig(BaseModel):
    ...
    llm_temperature: float = 0.0  # CRITICAL: 0.0 for deterministic/reproducible classifications
    ...
    maf_threshold:      float = float(os.getenv("MAF_THRESHOLD", "0.01"))       # MAF threshold (0=disabled, >0=enabled post-VEP)
